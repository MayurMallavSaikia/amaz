...
public class OrderController {
	...
	@PostMapping("/public/user/cart/{cartId}/payments/{paymentMethod}/order")
	public ResponseEntity<OrderDTO> orderProducts(@PathVariable Long cartId, @PathVariable String paymentMethod) {
		OrderDTO order = orderService.placeOrder(cartId, paymentMethod);
	...
	public ResponseEntity<OrderResponse> getAllOrdersPage(
	...
	List<OrderDTO> orderResponse = orderService.getAllOrder();
